...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/DuAnTuThien/vnpayresponse";
    public static String vnp_TmnCode = "L0AZPE4V";
    public static String vnp_HashSecret = "WHZIXBASMUKBDUUYTJDSXIUSHRRNAECA";
