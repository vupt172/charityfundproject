		...
		<form action="" class="create-form" method="post">
			<div class="form-group">
				<label class="form-label">ID</label> <input id="category-id"
					...
					value="${category.id}"> <span class="form-message"></span>
			</div>
			<div class="form-group">
				<label class="form-label">Name</label> <input id="category-name"
					type="text" class="form-control" name="name"
					value="${category.name}"> <span class="form-message""></span>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="form-label">Status</label> <select id="category-status"
