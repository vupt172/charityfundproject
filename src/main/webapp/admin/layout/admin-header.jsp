...
<header
	...
	<img src="${pageContext.request.contextPath}/images/clientlogo.png" alt="" style="width: 300px">
	...
	<div class="dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="userDropdownMenu">
			<a class="dropdown-item" style="width: 100%;" href="${pageContext.request.contextPath}/password?action=changepassword">Change
		...
		<ul class="navbar-nav mr-auto ">
			...
			<li class="nav-item"><a class="nav-link "
				href="${pageContext.request.contextPath}/admin/fund/"><i
					class="fa-solid fa-sack-dollar"></i> Quỹ quyên góp</a></li>
			<li class="nav-item"><a class="nav-link "
