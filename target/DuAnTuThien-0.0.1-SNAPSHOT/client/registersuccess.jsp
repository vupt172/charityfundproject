...
<body>
	<div class="card">
		...
		<div class="card-body">
			...
			<p class="card-text">Xin chào <b>${user.fullName}</b>,bạn đã đăng ký tài
				khoản thành công trên website duantuthien.com. Thông tin về tài
				khoản và link kích hoạt đã được gửi qua mail.
				<br>Vui lòng mở hòm thư để kiểm tra.</p>
